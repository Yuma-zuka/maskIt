...
class Homewindow:
    def __init__(self):
        ...
        self.image_process_btn = Button(self.root, text="image", command=self.do_imagerecpro, bg="#a1d6e2", fg="#537072", font=("Helvetica", 120))
        self.image_process_btn.place(relx=0.5, rely=0.4, anchor=tk.CENTER)

        self.movie_process_btn = Button(self.root, text="movie", command=self.do_movierecpro, bg="#a1d6e2", fg="#537072",  font=("Helvetica", 120))
