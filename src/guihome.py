...
class HomeWindow:
    def __init__(self):
        ...
        # ボタンに表示する画像の読み込み
        register_icon = tk.PhotoImage(file="material/register_icon.png")
        manage_icon = tk.PhotoImage(file="material/manage_icon.png")
        image_icon = tk.PhotoImage(file="material/image_icon.png")
        ...
        manage_process_btn = tk.Button(self.root, image=manage_icon, command=self.do_management) # do_managementメソッドの呼び出し
        ...
        # 写真の処理を実行するボタンとラベル
        image_process_btn = tk.Button(self.root, image=image_icon, command=self.do_imagerecpro) # do_imagerecproメソッドの呼び出し
        ...
        real_time_process_btn = tk.Button(self.root, image=real_time_icon, command=self.do_real_time_rec) # do_real_time_recメソッドの呼び出し
