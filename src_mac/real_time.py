...
class RealTimeRec(tk.Frame):
    def __init__(self, master = None):
        ...
        filter_change_button = Button(self.master, text="フィルター変更", bg="#bbdceb", fg="#000000", command=self.change_filter, font=("Helvetica", 50)) # フィルターを変更するボタンの設定 change_filterメソッドの呼び出し
        ...
        photo_button = Button(self.master, text="写真を撮る", bg="#f0cb45", fg="#ffffff", command=self.take_picture, font=("Helvetica", 50)) # 写真を撮るボタンの設定 take_pictureメソッドの呼び出し
